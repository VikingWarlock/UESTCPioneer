...
- (void)viewDidLoad
{
    ...
    [self.tableView registerClass:[CellForDailyCare_TitleCell class] forCellReuseIdentifier:@"CustomTitleCellIndentifier"];
    [self.tableView registerClass:[CellForDailyCare_BodyCell class] forCellReuseIdentifier:@"CustomMainCellIndentifier"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row == 0) {
        ...
        CellForDailyCare_TitleCell *cell = [tableView dequeueReusableCellWithIdentifier:customTitleCellIndentifier];
        if(cell == nil){
        ...
        CellForDailyCare_BodyCell *cell2 = [tableView dequeueReusableCellWithIdentifier:customMainCellIndentifier];;
        if(cell2 == nil){
